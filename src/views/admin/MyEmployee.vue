        ...
        <div class="curved-wrap">
            ...
            <div class="flex-center flex-column">
                <div v-if="employee.images.length > 0">
                    <b-img fluid :src="storage + employee.images[0].path" alt="Staff photo" class="staff-photo"></b-img>
                </div>
                <h5 class="mt-4 mb-1 font-weight-bold">{{employee.full_name}}</h5>
                <h6 class="gray">{{employee.title}}</h6>
                <div class="gray mt-3"><span class="yellow">{{employee.average_rating}}</span> ({{$tc('review', employee.review_count)}})</div>
